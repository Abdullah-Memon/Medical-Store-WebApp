<br>
<strong>
    <div class="container-fluid text-center  text-white" style="background-color: #4A93DF;">
        <h2>SERVICES</h2>
        <h4>What we offer</h4>
        <br>
        <div class=" row">
...
<!-- Copyright -->
<div class="footer-copyright text-center py-3 " style="background-color:#4A93DF; border-top: 1px solid #ccc;"> All Copyright © 2023 has been reserved by: :
    <a href="https://amcs.pk" target="_blank" style="color: white; text-decoration: none;">amcs.pk</a>
    <span> Developed by: </span>
    <a href="https://www.facebook.com/profile.php?id=100005380729151" target="_blank" style="color: white; text-decoration: none;">Abdullah Memon 20SW01</a>
</div>
