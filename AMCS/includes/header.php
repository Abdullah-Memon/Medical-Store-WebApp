<header>
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #4A93DF;">
        <div class="container-fluid">
            <a href="index.php"> <img src="images/AMCS.png" id="image" width="100%"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="navigation" style="width: 0%; margin: auto;">
