  ...
  <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="images/carousel1.jpg" class="d-block w-100" style="height: 700px;">
      </div>
      <div class="carousel-item">
        <img src="images/carousel2.jpg" class="d-block w-100" style="height: 700px;">
      </div>
      <div class="carousel-item">
        <img src="images/carousel3.jpg" class="d-block w-100" style="height: 700px;">
      </div>
      <div class="carousel-item">
        <img src="images/carousel4.jpg" class="d-block w-100" style="height: 700px;">
      </div>
    </div>
    ...
    <div class="row" id="cards">
      <div class="col-sm-3" id="cards">
        <div class="card " style="background-color: AntiqueWhite; height: 70%;">
          <div class="card-body">
            <strong style="background-color:  red; color: white;">&nbsp;UPTO 20% OFF&nbsp;</strong>
            <strong>
              <h5 style="font-weight:bold; color: rgb(104, 97, 97);"> Medicine Products</h5>
            </strong>
            <a href="search.php?cat=medicine">
              <img src="images/midicin.png" style="width:150.4px ; height:225px ;" class="d-block " alt="...">
            </a>
          </div>
        </div>
      </div>
      <div class="col-sm-3" id="cards">
        <div class="card " style="background-color: rgb(93, 179, 207) ;height: 70%; ">
          <div class="card-body">
            <strong style="background-color:  red ; color: white ; ;">&nbsp;UPTO 30% OFF&nbsp;</strong>
            <strong>
              <h5 style="font-weight:bold; color: rgb(104, 97, 97);"> Self care Products</h5>
            </strong>
            <a href="search.php?cat=self-care">
              <img src="images/self-care.png" style=" height:200px ;">
            </a>
          </div>
        </div>
      </div>
      <div class="col-sm-3" id="cards">
        <div class="card " style="background-color: rgb(81, 211, 216);height: 70%; ">
          <div class="card-body">
            <strong style="background-color:  red; color: white ; ;">&nbsp;UPTO 45% OFF&nbsp;</strong>
            <strong>
              <h5 style="font-weight:bold; color: rgb(104, 97, 97);">Machine Products</h5>
            </strong>
            <a href="search.php?cat=machine">
              <img src="images/machine.png" style="width:120.4px ; height:200px ;"><br>
            </a>
          </div>
        </div>
      </div>
      <div class="col-sm-3" id="cards">
        <div class="card " style="background-color: AntiqueWhite; height: 70%;">
          <div class="card-body">
            ...
            <a href="https://www.google.com/maps/place/Quaid-e-Awam+University+of+Engineering,+Science+and+Technology/@25.5275612,67.1531174,9z/data=!4m10!1m2!2m1!1squest!3m6!1s0x394a4cd3075ee1f5:0xa3643f4b36eec24f!8m2!3d26.234921!4d68.3881002!15sCgVxdWVzdCIDiAEBWgciBXF1ZXN0kgEKdW5pdmVyc2l0eZoBI0NoWkRTVWhOTUc5blMwVkpRMEZuU1VONWFEUm1SMU5uRUFF4AEA!16s%2Fm%2F05syjb9" target="_blank">
              <img src="images/location.png" style="width:150.4px ; height:200px ;"><br>
            </a>
          </div>
        </div>
      </div>
        ...
        <div class="col-sm-2" id="cards" style="width: 20.45rem;">
          <div class="card border border-warning">
            ...
            <div class="card-body">
              ...
              <br> <br>
              <strong>
                <h3 style="color :#82E0AA;" class="card-text"> RS. <?php echo $data[$i]['item_price'] ?></h3>
              </strong>
              <br>
